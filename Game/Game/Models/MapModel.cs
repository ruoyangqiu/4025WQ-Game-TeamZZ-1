...
namespace Game.Models
{
    ...
    public class MapModel
    {
        ...
        /// <returns></returns>
        public bool PopulateMapModel(List<EntityInfoModel> PlayerList)
        {
            ClearMapGrid();
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        public MapModelLocation GetLocationForPlayer(EntityInfoModel player)
        {
            if (player == null)
            {
                return null;
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        public EntityInfoModel GetPlayerAtLocation(int x, int y)
        {
        ...
        /// <returns></returns>
        public bool IsTargetInRange(EntityInfoModel Attacker, EntityInfoModel Defender)
        {
